...
# whether the second array is a subsequence of the first on

# A subsequence of an array is a set of numbers th necessarily adjacent in the 
# array but that are in the same order as they appear in the array.  For instance
# the numbers [1, 2, 3, 4] form a subsequence of the array [1, 2, 3, 4], and 
